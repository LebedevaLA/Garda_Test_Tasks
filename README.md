Я пыталась классы для калькулятора переместить в отдельные файлы, но пока не получилось написать правильные команды в докерфайле, чтобы это заработало ( <br>
<br>
